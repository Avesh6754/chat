...
@override
  void onInit() {
    ...
    super.onInit();
    UserFirestore.userFirestore.editStatus(email:AuthService.authService.getUser()!.email! , online: true, typing: false);
  }
...
return formatedate.value;
  ...
  void getReceiver(String email,String name,String image,bool online,bool typing)
  {
